...
CHROMA_PATH = ROOT / "chatbox" / "db" / "chroma_data"

OLD_COLLECTION = "tesis_universitarias"
NEW_COLLECTION = "tesis_universitarias_v11"
BATCH = 64


def main():
    print(f"Chroma origen: {CHROMA_PATH}")
    ...
    print(f"Colección nueva: {NEW_COLLECTION}")
    ...
    print("La colección antigua NO fue eliminada.")
